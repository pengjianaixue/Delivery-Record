...
public:
    ...
    void setupUi(QWidget *Configure)
    {
        ...
        Lable_email_sender->setObjectName(QString::fromUtf8("Lable_email_sender"));
        Lable_email_sender->setMinimumSize(QSize(30, 0));
        Lable_email_sender->setStyleSheet(QString::fromUtf8("image: url(:/DeliveryRecord/Resources/email_account_suser.png);"));

        verticalLayout->addWidget(Lable_email_sender);

        Lable_editsection_DelieveryComments = new QLabel(layoutWidget);
        Lable_editsection_DelieveryComments->setObjectName(QString::fromUtf8("Lable_editsection_DelieveryComments"));
        ...
        Lable_editsection_DelieveryComments->setStyleSheet(QString::fromUtf8("image: url(:/DeliveryRecord/Resources/Subject one.png);"));

        verticalLayout->addWidget(Lable_editsection_DelieveryComments);

        Lable_editsection_EmailRecviers = new QLabel(layoutWidget);
        Lable_editsection_EmailRecviers->setObjectName(QString::fromUtf8("Lable_editsection_EmailRecviers"));
        ...
        Lable_editsection_EmailRecviers->setStyleSheet(QString::fromUtf8("image: url(:/DeliveryRecord/Resources/Email Connect.png);"));
        ...
        lineEdit_emailsender->setObjectName(QString::fromUtf8("lineEdit_emailsender"));
        ...
        comboBox_emailrecviers->setObjectName(QString::fromUtf8("comboBox_emailrecviers"));
        ...
        pushButton_addEmailRecvier->setObjectName(QString::fromUtf8("pushButton_addEmailRecvier"));
        ...
        pushButton_addEmailRecvier->setStyleSheet(QString::fromUtf8(""));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/DeliveryRecord/Resources/add.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        pushButton_removeEmailRecvier->setObjectName(QString::fromUtf8("pushButton_removeEmailRecvier"));
        ...
        pushButton_removeEmailRecvier->setStyleSheet(QString::fromUtf8(""));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/DeliveryRecord/Resources/remove.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tableWidget_emailcontents->setObjectName(QString::fromUtf8("tableWidget_emailcontents"));
    ...
    void retranslateUi(QWidget *Configure)
    {
        ...
        pushButton_addEmailRecvier->setText(QApplication::translate("Configure", "AddReceiver", nullptr));
        pushButton_removeEmailRecvier->setText(QApplication::translate("Configure", "RemoveReceiver", nullptr));
